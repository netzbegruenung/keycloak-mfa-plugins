...
@SpringBootTest(classes = { AuthorizationServerApp.class }, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
@ActiveProfiles("livetest")
public class EnforceMfaLiveTest {
	private static final Logger log = LoggerFactory.getLogger(EnforceMfaLiveTest.class);
