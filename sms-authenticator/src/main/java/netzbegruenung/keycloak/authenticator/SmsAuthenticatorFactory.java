...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("customHeaders", "Custom HTTP headers", "Additional HTTP headers sent with every SMS API request, one per line as 'Header-Name: value'. A header listed here overrides the default 'Accept: application/json' header. Applies to POST (JSON/urlencoded) and GET modes.", ProviderConfigProperty.TEXT_TYPE, ""),
