...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("receiverUsesList", "Receiver sent as list", "Receiver attribute supports sending one or more phone numbers as a list instead of a string", ProviderConfigProperty.BOOLEAN_TYPE, false),
