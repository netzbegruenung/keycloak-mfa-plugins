...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("hideBackToApplicationLink", "Hide back link on the code form", "Hide the link below the SMS code input. The link is labelled \"Back to Application\" but points at the account console of the realm, and following it mid-flow abandons the login.", ProviderConfigProperty.BOOLEAN_TYPE, false),
