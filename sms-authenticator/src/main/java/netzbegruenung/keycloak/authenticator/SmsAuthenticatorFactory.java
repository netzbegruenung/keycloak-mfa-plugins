...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("apiTokenInHeader", "Put API Secret Token in Authorization Header", "If set, API Secret will be send as Authorization Header, 'API Secret Token Attribute' and 'Basic Auth Username' will be ignored.", ProviderConfigProperty.BOOLEAN_TYPE, false),
