...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("getUrl", "SMS API GET URL template", "If your SMS API expects a GET request instead of POST, you can set here a URL template with {phone}, {message} placeholders for phone number and message. If empty, a POST request will be sent.", ProviderConfigProperty.STRING_TYPE, ""),
			...
			new ProviderConfigProperty("enableCountryCodeList", "Enable country code list", "Enable the list of all countries", ProviderConfigProperty.BOOLEAN_TYPE, false),
			new ProviderConfigProperty("enableItelTelInput", "Enable International Telephone Input", "Enable the list of all countries based on International Telephone Input", ProviderConfigProperty.BOOLEAN_TYPE, false),
			new ProviderConfigProperty("countryCodeList", "List of country code", "Sets the list of country code in a select input to display to the user the supported countries. Possible values are the region Code_ FR, DE, GB", ProviderConfigProperty.MULTIVALUED_STRING_TYPE, Collections.emptyList())
		);
	}
