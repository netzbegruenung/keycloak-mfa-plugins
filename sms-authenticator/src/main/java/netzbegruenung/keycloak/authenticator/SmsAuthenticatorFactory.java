...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("customHeaders", "Custom HTTP headers", "Additional HTTP request headers, one per line in \"Header: value\" format. Headers already set by the plugin are ignored.", ProviderConfigProperty.TEXT_TYPE, ""),
