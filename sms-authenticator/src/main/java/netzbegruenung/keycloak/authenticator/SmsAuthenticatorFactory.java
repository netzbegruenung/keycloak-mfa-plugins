...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("storeInAttribute", "Set phone number as attribute", "Sets the phone number as a user attribute. When active, the attribute is the source of truth: it wins over the stored credential, and users whose attribute is already populated (e.g. via LDAP federation) can authenticate without enrolling an SMS credential.", ProviderConfigProperty.BOOLEAN_TYPE, false),
