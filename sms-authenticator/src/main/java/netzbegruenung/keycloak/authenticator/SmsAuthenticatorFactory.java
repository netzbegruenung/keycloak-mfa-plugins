...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("urlencodeOtherProperties", "URL encode additional properties", "Additional key=value pairs to append to the URL-encoded POST body (e.g. 'key=value'). Only used when 'URL encode data' is enabled.", ProviderConfigProperty.MULTIVALUED_STRING_TYPE, Collections.emptyList()),
