...
class PhoneNumberRequiredActionFactoryTest {
	...
	private PhoneNumberRequiredActionFactory factory;
	@Mock
	private KeycloakSession session;

	@BeforeEach
	void setUp() {
		factory = new PhoneNumberRequiredActionFactory();
	}
	...
	class RequiredActionCreation {
		...
		@Test
		@DisplayName("should create PhoneNumberRequiredAction instance")
