...
Reference implementation with Dart: [verdigado/kc_auth_app](https://github.com/verdigado/kc_auth_app)
...
[HTTP Message Signatures (Draft)](https://datatracker.ietf.org/doc/html/draft-ietf-httpbis-message-signatures). Note: The draft has been finalized and published as [RFC 9421](https://datatracker.ietf.org/doc/rfc9421/).

The `Signature` header is used to authenticate requests. It contains a signature created by the client using its private key. The header is a comma-separated string of key-value pairs.
